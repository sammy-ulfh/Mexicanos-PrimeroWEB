...
const completarForm = async (req, res) => {
    try {
      ...
      if (type === 2) {
        ...
        const { rfc_resp, correo_responsable, tipo, inst, nombre_responsable, correo_institucion, rfc, edad_responsable, nombre_institucion, ine, report } = req.body;
        await newInfoDonador.newInfoDonador(rfc_resp, correo_responsable, id_usuario, tipo, inst, nombre_responsable, correo_institucion, rfc, edad_responsable, nombre_institucion, ine, report);
      }
