...
const Info = {
    ...
    genero: 'Masculino',
    resumen_publico: `
Profesional responsable de la gestión y supervisión de una plataforma digital dedicada a facilitar conexiones entre escuelas con necesidades específicas (infraestructura, materiales educativos, tecnología, etc.) y potenciales donadores (particulares, empresas, ONGs). Su rol principal es garantizar el buen funcionamiento del sistema, la validación de perfiles, la transparencia en los procesos de donación y la comunicación efectiva entre las partes.
    `
}
            ...
            <div className='w-[80%] h-auto font-bold font-montserrat flex flex-col justify-start items-center'>
              ...
              <section className='w-full h-[15vh] flex justify-center items-center mt-[2%]'>
                <div className='h-full flex justify-center items-center'>
                  <img src={Info.image} alt='Imagen de perfil' className='rounded-full w-[30%] border'/>
                </div>
        ...
        Cambiar
            ...
            <section className='w-[80%] h-auto font-bold font-montserrat flex flex-col justify-start items-center mt-[2%]'>
              <div className='w-full h-[15vh] flex flex-col justify-center items-center'>
                ...
                <input type='text' placeholder={Info.email} className='w-[95%] h-[80%] bg-white border rounded-3xl pl-[3%]' />
              </div>
              ...
              <div className='w-full h-[15vh] flex flex-col justify-center items-center'>
                ...
                <input type='text' placeholder={Info.genero} className='w-[95%] h-[80%] bg-white border rounded-3xl pl-[3%]' />
              </div>
              ...
              <div className='w-full h-[30vh] flex flex-col justify-center items-center'>
                ...
                <textarea rows='200' placeholder={Info.resumen_publico} className='w-[95%] h-[80%] bg-white resize-none border rounded-3xl p-[3%]' />
              </div>
