            ...
            <div className='fixed right-0 top-0 z-2 flex flex-col mt-[15vh] items-center justify-start h-[85vh] w-[30vw] lg:hidden xl:hidden bg-white border border-gray-100'>
                ...
                <nav className='w-[100%] h-[90%] lg:hidden xl:hidden'>
                  <ul className='w-full h-full flex flex-col justify-start items-center mt-[15%] text-xs sm:text-sm md:text-base'>
                    ...
                    <li className='w-[80%] h-[7%] m-[1%]'>
                      <button className='hover:scale-110 transition duration-300 border border-black rounded-3xl bg-[#009933] flex justify-center items-center font-bold font-montserrat w-full h-full' onClick={() => navigate('/portal/chats', {state: 'school'})}>
                        Mis chats
                      </button>
                    </li>
                    <li className='w-[80%] h-[7%] m-[1%]'>
                      <button className='hover:scale-110 transition duration-300 border border-black rounded-3xl bg-[#009933] flex justify-center items-center font-bold font-montserrat w-full h-full' onClick={() => navigate('/configuration/profile', {state: 'school'} )}>
                        Mi perfil
                      </button>
                    </li>
                    <li className='w-[80%] h-[7%] m-[1%]'>
