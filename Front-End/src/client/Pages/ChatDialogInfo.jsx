      ...
      <main className="flex-grow flex items-center justify-center w-full py-8">
        ...
        >
          ...
          <div className="border border-gray-300 rounded-lg p-4 bg-gray-50 mb-6">
            ...
            {/* Campo: Resumen del proceso */}
            <label
              className="block font-semibold text-sm mb-1"
              htmlFor="resumenApoyo"
            >
              Resumen de lo que hará durante el proceso de apoyo
            </label>
            <textarea
              id="resumenApoyo"
              placeholder="Escribe aquí los detalles del proceso..."
              className="w-full p-2 border border-gray-300 rounded text-sm"
              rows="3"
            />

            {/* Botón: Enviar (o guardar) */}
            <button
              className="mt-4 px-6 py-2 rounded-full text-white bg-green-600 font-semibold text-sm hover:scale-105 transition-transform duration-300"
            >
              Enviar
            </button>
          </div>
