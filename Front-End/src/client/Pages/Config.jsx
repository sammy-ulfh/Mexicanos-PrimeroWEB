            ...
            <div className='w-full h-[20vh] text-black font-bold font-montserrat flex flex-col justify-center items-center'>
              ...
              <article id='modal1' className='mt-[-2%] pb-[3%] pt-[4%] w-[75%] bg-white border rounded-xl font-bold font-motserrat flex flex-col'>
                <div className='w-[80%] ml-[4%]'>
                  ...
                  <input className='w-[113%] h-[45px] pl-[5%] border rounded-xl bg-white text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-3xl' placeholder='*****' />
                </div>
              ...
              <div className='w-[80%] mt-[1%] h-[15vh] z-1 bg-gray-300 rounded-3xl flex justify-center items-center font-bold font-montserrat'>
                <h2 className='w-[70%] flex justify-center items-center text-xl sm:text-2xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-5xl'>Eliminar cuenta</h2>
                <div className='w-[30%] h-[100%] z-2 flex justify-center items-center'>
                { isAdmin ? (
                  <button id='triangle' className="w-[60%] xl:w-[30%] 2xl:w-[30%] h-[50%] z-2 rounded-4xl border hover:scale-105 transition duration-300 bg-[url('/src/admin/assets/pages/config/triangle.png')] bg-cover bg-no-repeat bg-center bg-white" style={{ backgroundSize: '50%'}} onClick={isAdmin ? () => setIsAdmin(false) : () => setIsAdmin(true)} />
                  ) : (
                  <button id='triangle' className="w-[60%] xl:w-[30%] 2xl:w-[30%] h-[50%] z-2 rounded-4xl border hover:scale-105 transition duration-300 bg-[url('/src/admin/assets/pages/config/triangle.png')] bg-cover bg-no-repeat bg-center bg-white scale-y-[-1] hover:scale-y-[-1]" style={{ backgroundSize: '50%'}} onClick={isAdmin ? () => setIsAdmin(false) : () => setIsAdmin(true)} />
                )} 
                </div>
              </div>
