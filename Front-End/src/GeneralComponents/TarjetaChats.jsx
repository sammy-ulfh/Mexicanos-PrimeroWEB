const TarjetaChats = ({user_id, chat_id, info, last_message, navigate}) => (
  <article className='p-[2%] w-[80%] font-bold font-montserrat flex justify-center items-center text-black font-montserrat border rounded-3xl m-[1%]'>
    ...
    <div className='flex flex-col w-[40%] h-full justify-center items-center'>
      ...
      <button className='border rounded-3xl text-sm sm:text-sm md:text-base lg:text-lg xl:text-xl w-[50%] md:w-[40%] lg:w-[40%] xl:w-[40%] h-[5vh] mt-[1%] bg-[#009933] hover:scale-105 transition duration-300' onClick={() => navigate('/portal/perfil', { state: [info.type,info.id] })}>
        Ver perfil
      </button>
    </div>
